...
public class ReplyRestController {
	...
	@GetMapping("/create")
	public ResponseEntity<List<ReplyCreateDto>> Create(ReplyCreateDto replyCreateDto,HttpSession session) throws Exception {
	...
	@PutMapping
	public ResponseEntity<List<ReplyCreateDto>> update(ReplyCreateDto replyCreateDto,HttpSession session) throws Exception{
		ReplyBoard replyBoard = ReplyCreateDto.toEntity(replyCreateDto);
	...
	@DeleteMapping
	public ResponseEntity<List<ReplyCreateDto>> delete(ReplyCreateDto replyCreateDto,HttpSession session) throws Exception{
